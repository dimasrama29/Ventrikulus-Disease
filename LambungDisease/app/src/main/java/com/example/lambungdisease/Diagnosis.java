...
public class Diagnosis extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
            ...
            public void onClick(View v) {
                try {
                    ...
                    if (mRg1 != null && mRg2 != null && mRg3 != null && mRg4 != null
                        ...
                        Ebayes2 = ((Gbayes9 * i9) + (Gbayes10 * i10) + (Gbayes11 * i11)
                                + (Gbayes12 * i12) + (Gbayes13 * i13) + (Gbayes14 * i14)
                        ...
                        if (Nbayes1 > Nbayes2 && Nbayes1 > Nbayes3 && Nbayes1 > Nbayes4 && Nbayes1 > Nbayes5){
                            hasil = "Anda diperkirakan menderita sakit Gastritis, Segera cek ke dokter lambung terdekat";
                        }else if (Nbayes2 > Nbayes3 && Nbayes2 > Nbayes4 && Nbayes2 > Nbayes5 && Nbayes2 > Nbayes1){
                            hasil = "Anda diperkirakan menderita sakit Dispepsia, Segera cek ke dokter lambung terdekat";
                        }else if (Nbayes3 > Nbayes4 && Nbayes3 > Nbayes2 && Nbayes3 > Nbayes5 && Nbayes3 > Nbayes1){
                            hasil = "Anda diperkirakan menderita sakit GERD / Asam Lambung, Segera cek ke dokter lambung terdekat";
                        }else if (Nbayes4 > Nbayes5 && Nbayes4 > Nbayes1 && Nbayes4 > Nbayes2 && Nbayes4 > Nbayes3){
                            hasil = "Anda diperkirakan menderita sakit Maag, Segera cek ke dokter lambung terdekat";
                        }else if (Nbayes5 > Nbayes1 && Nbayes5 > Nbayes2 && Nbayes5 > Nbayes3 && Nbayes5 > Nbayes4){
                            hasil = "Anda diperkirakan menderita Tukak Lambung, Segera cek ke dokter lambung terdekat";
                        }else{
                            hasil = "Selamat lambung Anda Baik dan Sehat, Tetap jaga diri ya!";
                        }

                        Intent intent = new Intent(Diagnosis.this, LaporanDiagnosis.class);
        ...
        DatabaseReference dbR5 = FirebaseDatabase.getInstance().getReference("biodata");
        Map<String, Object> hopperUpdates = new HashMap<>();
        hopperUpdates.put("penyakit", mHasil);
